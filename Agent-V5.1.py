# Agent-V5.py — Thread-safe UI with Rounded Message Bubbles
import sys
import os
import re
import threading
...
class AgentApp(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("DeepSeek AI Agent")
    ...
    def setup_ui(self):
        ...
        # Chat header
        header = QLabel("DeepSeek AI Assistant")
        ...
        self.system_message.emit("🤖 Welcome to DeepSeek AI Assistant! I'm ready to help you with document analysis, questions, and more.")
